...
if ($addnew=="1" )
{
  ...
  $sql="update 153111040xinwentongzhi set biaoti='$biaoti',leibie='$leibie',neirong='$neirong',dianjilv='$dianjilv',tianjiaren='$tianjiaren' where id= ".$id;
  $conn = new ConnectDb();
...
<?php
  $sql="select * from 153111040xinwentongzhi where id=".$id;
  $conn = new ConnectDb();
