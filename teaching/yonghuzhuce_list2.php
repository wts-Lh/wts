...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#6699CC" style="border-collapse:collapse">
  <tr>
    ...
    <td width="94" bgcolor='#EBE2FE'>权限</td>
    <td width="94" bgcolor='#EBE2FE'>余额</td>
...
{
    $nreqbh=@$_POST["bh"];
    $sql=$sql." and id like '%$nreqbh%'";
}
     if (@$_POST["mc"]!="")
{
    $nreqmc=@$_POST["mc"];
    $sql=$sql." and name like '%$nreqmc%'";
}
  ...
  <tr>
    ...
    <td> <?php echo $res2['pwd'];?></td>
    <td> <?php echo $res2['pos'];?></td>
    <td> <?php echo $res2['money'];?></td>
</td>
    <td width="70" align="center"><a href="del.php?id=del.php?id= <?php echo $res2['id'];?>
    &tablename=yonghuzhuce" onclick="return confirm('真的要删除？')">删除</a>
        <a href="yonghuzhuce_updt2.php?id= <?php
    echo $res2["id"];
  ?>">修改</a></td>
  </tr>
     <?php
